      ...
      <div className="userAgree">
        <div className="userAgree__inner">
          <div className="userAgree__text">
            ...
            <p className="userAgree__numbering">이용약관 1조 목적</p>
            <p className="userAgree__content">
              이 약관은 ㈜Nomad Donut이 운영하는 애플리케이션 havit 시스템을
              이용하는 ‘havit’ MOU체결 병의원(이하 ‘제휴병의원’)과 이용자의
              권리•의무 및 책임사항을 규정함을 목적으로 합니다.
            </p>
            <p className="userAgree__numbering">제2조 정의</p>
            <p className="userAgree__content">
            ...
            <p className="userAgree__numbering">제3조 약관의 명시와 개정</p>
            <p className="userAgree__content">
