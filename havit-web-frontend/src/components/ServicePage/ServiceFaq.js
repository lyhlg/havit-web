              ...
              <tbody>
                ...
                {this.state.isOpened[2] && (
                  <tr className="q1">
                    <td className="qa">A.</td>
                    <td>
                      <p>상품을 예약함과 동시에 상담전화 예약을 하게됩니다.</p>
                      <p>통화 가능한 시간대에 예약하실 수 있습니다.</p>
                      <p>
                ...
                {this.state.isOpened[5] && (
                  <tr className="q1">
                    <td className="qa">A.</td>
                    <td>
                      <p>크레딧은 현금처럼 사용이 가능합니다.</p>
                      <p>이벤트, 시술후기 등으로 적립하실 수 있습니다.</p>
                    </td>
                  </tr>
                )}
